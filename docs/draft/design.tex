...
%% 
% why use shortterm only instead of weighted averages?
% short-term info is more indicative (\ref{fig:bat_v_time} )
% because weighted averages result in overestimation of remaining battery life.
% Without a model of user behavior, we assume the user could proceed with 
%current activity until the battery is depleted.

%%
% limited to currently running apps -- reduces /proc parsing overhead
% 
