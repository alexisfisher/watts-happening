...
\emph{Watt's Happening} was intended to be a more general application that can provide useful information to a user regardless of their device's hardware. 
...
Also, being that network operations were shown to be enery intensive, a recommendation system should place an emphasis on applications that abuse the devices networking.
...
Eventually, \emph{Watt's Happening} looks leverage user profiling to automatically control the power of different radios on the device. 
...
Intelligent models are necessary in order to keep from being too intrusive in user actions.
